...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $stmt = $mysqli->prepare("SELECT resetcode, created_at FROM bnhs_admin WHERE admin_email = ?");
  ...
  if ($user) {
    ...
    if ($enteredCode === trim($user['resetcode'])) {
      ...
      $update = $mysqli->prepare("UPDATE bnhs_admin SET resetcode = NULL WHERE admin_email = ?");
