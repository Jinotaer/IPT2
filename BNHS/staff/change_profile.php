                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="form-group">
                          ...
                          <input style="color: black;" type="password" name="old_password" id="oldpasswordField"
                            class="form-control form-control-alternative">
                            <img src="assets/img/theme/show.png" id="toggleIcon1" onclick="togglePassword('oldpasswordField', 'toggleIcon1')" style="position: absolute; right: 30px; top: 55%; transform: translateY(-50%); cursor: pointer; width: 20px; height: 20px;">
                        </div>
                      </div>
                      ...
                      <div class="col-lg-12">
                        <div class="form-group">
                          ...
                          <input style="color: black;" type="password" name="new_password"
                            class="form-control form-control-alternative" id="passwordField">
                            <img src="assets/img/theme/show.png" id="toggleIcon2" onclick="togglePassword('passwordField', 'toggleIcon2')" style="position: absolute; right: 30px; top: 55%; transform: translateY(-50%); cursor: pointer; width: 20px; height: 20px;">
                        </div>
                      </div>
                      ...
                      <div class="col-lg-12">
                        <div class="form-group">
                          ...
                          <input style="color: black;" type="password" name="confirm_password"
                            class="form-control form-control-alternative" id="confirmPasswordField">
                            <img src="assets/img/theme/show.png" id="toggleIcon3" onclick="togglePassword('confirmPasswordField', 'toggleIcon3')" style="position: absolute; right: 30px; top: 55%; transform: translateY(-50%); cursor: pointer; width: 20px; height: 20px;">
                        </div>
                      </div>
